...
class Pzmagento extends \Magento\Payment\Model\Method\AbstractMethod {

    const PAYMENT_PZMAGENTO_CODE = 'pzmagento';
    const ACC_BIZ = 'pzmagentobiz';
    const ACC_MONEY = 'pzmagentomoney';

    protected $_code = self::PAYMENT_PZMAGENTO_CODE;
     ...
     */
      public function __construct(
        ...
        \PzmagentoPayment\Pzmagento\Helper\Pzmagento $helper,
    ...
    public function generatePzmagentoHash($amount, $productInfo, $name,
            $email) {
